...
(function() {
    ...
    gui = new dat.GUI();
    gui.add(control, 'particleNum', 0, 3000).step(1).name('Количество частиц').onChange(function() {
    ...
    gui.add(GravityPoint, 'interferenceToPoint').name('Взаимное притяжение черных дыр');
    gui.close();
